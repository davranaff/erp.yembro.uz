...
OPERATIONAL_ALERT_SPECS: dict[str, OperationalAlertSpec] = {
    ...
    "chick_arrivals": OperationalAlertSpec(resource_label="Приход птенцов", module_label="Фабрика"),
    "feed_arrivals": OperationalAlertSpec(resource_label="Приход кормов", module_label="Фабрика"),
    "feed_consumptions": OperationalAlertSpec(resource_label="Расход корма", module_label="Маточник"),
    ...
    "feed_raw_arrivals": OperationalAlertSpec(resource_label="Приход сырья", module_label="Корма"),
    "feed_production_batches": OperationalAlertSpec(resource_label="Выпуск продукта", module_label="Корма"),
    "feed_raw_consumptions": OperationalAlertSpec(resource_label="Расход сырья", module_label="Корма"),
    "feed_product_shipments": OperationalAlertSpec(resource_label="Отгрузки продукта", module_label="Корма"),
    "medicine_arrivals": OperationalAlertSpec(resource_label="Приход лекарств", module_label="Вет аптека"),
    "medicine_batches": OperationalAlertSpec(resource_label="Партии лекарств", module_label="Вет аптека"),
    "medicine_consumptions": OperationalAlertSpec(resource_label="Уход лекарств", module_label="Вет аптека"),
    "medicine_types": OperationalAlertSpec(resource_label="Типы лекарств", module_label="Вет аптека"),
    "slaughter_arrivals": OperationalAlertSpec(resource_label="Приход птицы", module_label="Убойня"),
