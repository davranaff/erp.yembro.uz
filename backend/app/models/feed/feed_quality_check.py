...
class FeedProductionQualityCheck(Base, IDMixin, TimestampMixin):
    __tablename__ = "feed_production_quality_checks"
    ...
    production_batch_id: Mapped[UUID] = mapped_column(
        ForeignKey("feed_production_batches.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
