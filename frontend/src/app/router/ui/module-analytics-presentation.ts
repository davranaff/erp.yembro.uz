...
const MODULE_ANALYTICS_BLUEPRINTS: Record<string, ModuleAnalyticsBlueprint> = {
    ...
    sections: [
      {
        ...
        titleFallback: 'Главное',
        descriptionKey: 'dashboard.moduleOverviewDescription',
        descriptionFallback: '{module}: закладки, вывод и отгрузки.',
        metricKeys: ['eggs_set', 'chicks_hatched', 'hatch_rate', 'chicks_dispatched'],
  ...
  factory: {
    summaryMetricKeys: ['total_birds', 'mortality_rate', 'total_shipped', 'active_alerts'],
    sections: [
      {
        id: 'overview',
        titleKey: 'dashboard.moduleOverviewTitle',
        titleFallback: 'Главное',
        descriptionKey: 'dashboard.moduleOverviewDescription',
        descriptionFallback: '{module}: поголовье, падёж, вес и отгрузки.',
        metricKeys: [
          'total_birds',
          'mortality_rate',
          'fcr',
