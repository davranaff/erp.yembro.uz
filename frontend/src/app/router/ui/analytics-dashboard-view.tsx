...
const SUMMARY_ICON_MAP: Record<string, LucideIcon> = {
  ...
  feed_arrived: ArrowUpRight,
  medicine_arrived: ArrowUpRight,
  chicks_arrived: ArrowUpRight,
  birds_arrived: ArrowUpRight,
  raw_arrivals: ArrowUpRight,
  medicine_arrivals: ArrowUpRight,
  feed_consumed: ArrowDownRight,
  medicine_consumed: ArrowDownRight,
  client_base: Building2,
  raw_consumed: ArrowDownRight,
...
const METRIC_CATEGORY_MAP: Record<string, MetricCategory> = {
  ...
  eggs_set: 'operations',
  chicks_arrived: 'operations',
  birds_arrived: 'operations',
  feed_arrived: 'operations',
  medicine_arrived: 'operations',
  raw_arrivals: 'operations',
  feed_consumed: 'operations',
  medicine_consumed: 'operations',
  raw_consumed: 'operations',
