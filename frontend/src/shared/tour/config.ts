...
export const TOUR_DEFINITIONS: readonly TourDefinition[] = [
  ...
  },
  {
    id: 'login-tour',
    version: 1,
    titleKey: 'tour.tours.login.title',
    descriptionKey: 'tour.tours.login.description',
    titleFallback: 'Тур по входу',
    descriptionFallback: 'Покажет логотип, форму входа и отправку данных в систему.',
    route: LOGIN_ROUTE_MATCHER,
    priority: 130,
    autoStart: true,
    ...
    steps: [
      {
        id: 'login-showcase',
        target: '[data-tour="login-showcase"]',
        titleKey: 'tour.steps.loginShowcase.title',
        descriptionKey: 'tour.steps.loginShowcase.description',
        titleFallback: 'Брендовый блок',
        descriptionFallback: 'В верхнем углу находится логотип и быстрый ориентир по продукту.',
      },
      {
        id: 'login-form',
        target: '[data-tour="login-form"]',
        titleKey: 'tour.steps.loginForm.title',
        descriptionKey: 'tour.steps.loginForm.description',
        titleFallback: 'Форма входа',
        descriptionFallback: 'Основной контейнер входа в систему.',
      },
      {
        id: 'login-credentials',
        target: '[data-tour="login-credentials"]',
        titleKey: 'tour.steps.loginCredentials.title',
        descriptionKey: 'tour.steps.loginCredentials.description',
        titleFallback: 'Учётные данные',
        descriptionFallback: 'Здесь вводятся логин сотрудника и пароль.',
      },
      {
        id: 'login-submit',
        target: '[data-tour="login-submit"]',
        titleKey: 'tour.steps.loginSubmit.title',
        descriptionKey: 'tour.steps.loginSubmit.description',
        titleFallback: 'Вход в систему',
        descriptionFallback: 'Отправляет форму и открывает рабочее пространство.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    descriptionFallback: 'Покажет профиль, доступы, безопасность и рабочий контекст.',
    route: '/settings',
    priority: 110,
    steps: [
      {
      ...
      {
        id: 'settings-access-summary',
        target: '[data-tour="settings-access-summary"]',
        titleKey: 'tour.steps.settingsAccess.title',
        descriptionKey: 'tour.steps.settingsAccess.description',
        titleFallback: 'Роли и доступы',
        descriptionFallback: 'Текущие роли, права и сводка по доступам пользователя.',
      },
      {
        id: 'settings-context-summary',
        target: '[data-tour="settings-context-summary"]',
        titleKey: 'tour.steps.settingsContext.title',
        descriptionKey: 'tour.steps.settingsContext.description',
        titleFallback: 'Рабочий контекст',
        descriptionFallback: 'Текущая организация и отдел, которые определяют рабочую область.',
      },
      {
