...
const baseMessages: Record<Language, Record<string, unknown>> = {
  ru: {
    ...
    resources: {
      ...
      'stock-takes': { label: 'Инвентаризация' },
      'reorder-levels': { label: 'Точки заказа' },
  ...
  uz: {
    ...
    resources: {
      ...
      'stock-takes': { label: 'Inventarizatsiya' },
      'reorder-levels': { label: 'Buyurtma chegaralari' },
  ...
  en: {
    ...
    resources: {
      ...
      'stock-takes': { label: 'Stock takes' },
      'reorder-levels': { label: 'Reorder levels' },
      'department-modules': { label: 'Модули отделов' },
      clients: { label: 'Клиенты' },
      currencies: { label: 'Валюты' },
      'poultry-types': { label: 'Типы птицы' },
