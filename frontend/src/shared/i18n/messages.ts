...
const baseMessages: Record<Language, Record<string, unknown>> = {
  ru: {
    common: {
      ...
      logoutConfirm: 'Выйти из системы? Несохранённые изменения в открытых формах будут потеряны.',
      unsavedNavigationConfirm: 'В открытой форме есть несохранённые изменения. Покинуть страницу?',
      sessionExpiringTitle: 'Сессия скоро истечёт',
      sessionExpiringDescription: 'Сохраните изменения и войдите заново, чтобы не потерять работу.',
    ...
    nav: {
      ...
      departmentsEmpty: 'У вас нет доступных отделов. Попросите администратора назначить отдел.',
    ...
    crud: {
      ...
      emptyHint: 'Создайте первую запись или измените фильтры, чтобы увидеть данные.',
      loadingRecords: 'Загружаем данные…',
      loadingAuditHistory: 'Загружаем историю изменений…',
      auditEmptyHint: 'Изменения по этой записи появятся здесь автоматически.',
    ...
    fields: {
      ...
      arrival_currency_id: 'Валюта прихода',
    ...
    resources: {
      ...
      advances: { label: 'Подотчётные' },
      consumptions: { label: 'Расход' },
      arrivals: { label: 'Партии (приход)' },
      processings: { label: 'Убой' },
      'semi-products': { label: 'Разделка' },
      'semi-product-shipments': { label: 'Отгрузки' },
  ...
  uz: {
    common: {
      ...
      logoutConfirm: 'Tizimdan chiqilsinmi? Ochiq formalardagi saqlanmagan o‘zgarishlar yo‘qoladi.',
      unsavedNavigationConfirm:
        'Ochiq formada saqlanmagan o‘zgarishlar bor. Sahifani tark etilsinmi?',
      sessionExpiringTitle: 'Sessiya tez orada tugaydi',
      sessionExpiringDescription:
        'O‘zgarishlarni saqlang va ishni yo‘qotmaslik uchun qayta tizimga kiring.',
    ...
    theme: { label: 'Mavzu', light: 'Yorug‘', dark: 'Qorong‘u', system: 'Tizim' },
    crudShell: {
    ...
    nav: {
      ...
      departmentsEmpty: 'Sizga mavjud bo‘limlar yo‘q. Administratordan bo‘lim berishni so‘rang.',
      profileMenu: 'Profil menyusi',
      breadcrumb: 'Navigatsiya yo‘li',
      commandPalette: 'Tezkor navigatsiya',
      navigate: 'navigatsiya',
      openAction: 'ochish',
      quickJump: 'Tezkor navigatsiya',
    },
    route: {
    ...
    crud: {
      ...
      emptyHint: 'Yangi yozuv qo‘shing yoki filtrlarni o‘zgartiring.',
      loadingRecords: 'Ma’lumotlar yuklanmoqda…',
      loadingAuditHistory: 'O‘zgarishlar tarixi yuklanmoqda…',
      auditEmptyHint: 'Bu yozuv bo‘yicha o‘zgarishlar shu yerda avtomatik paydo bo‘ladi.',
    ...
    fields: {
      ...
      net_meat_kg: 'Toza go‘sht, kg',
      waste_kg: 'Chiqindilar, kg',
      ...
      arrival_currency_id: 'Kelish valyutasi',
    ...
    resources: {
      ...
      advances: { label: 'Podhisobotli pullar' },
      consumptions: { label: 'Sarflar' },
      arrivals: { label: 'Partiyalar (kirim)' },
      processings: { label: "So'yish" },
      'semi-products': { label: "Bo'laklash" },
      'semi-product-shipments': { label: "Jo'natmalar" },
  ...
  en: {
    common: {
      ...
      logoutConfirm: 'Sign out? Unsaved changes in open forms will be lost.',
      unsavedNavigationConfirm: 'There are unsaved changes in an open form. Leave the page?',
      sessionExpiringTitle: 'Session is about to expire',
      sessionExpiringDescription: 'Save your changes and sign in again to avoid losing work.',
    ...
    nav: {
      ...
      departmentsEmpty: 'You have no departments yet. Ask an administrator to assign one.',
    ...
    crud: {
      ...
      clearForm: 'Очистить форму',
      actions: 'Actions',
      emptyResource: 'No records yet for “{resource}”.',
      emptyHint: 'Create the first record or adjust the filters to see data.',
      loadingRecords: 'Loading records…',
      loadingAuditHistory: 'Loading change history…',
      auditEmptyHint: 'Changes to this record will appear here automatically.',
    ...
    fields: {
      ...
      arrival_currency_id: 'Arrival currency',
    ...
    resources: {
      ...
      processings: { label: 'Slaughter' },
      'semi-products': { label: 'Cutting' },
      'semi-product-shipments': { label: 'Shipments' },
      'expense-categories': { label: 'Категории расходов' },
      expenses: { label: 'Расходы' },
      employees: { label: 'Сотрудники' },
      positions: { label: 'Должности' },
...
const translationOverrides: Partial<Record<Language, Record<string, unknown>>> = {
  ru: {
    ...
    fields: {
      ...
      acknowledged_at: 'Принято в',
      acknowledged_by: 'Принял',
      amount_in_base: 'Сумма в базовой валюте',
      counterparty_id: 'Контрагент',
      counterparty_type: 'Тип контрагента',
      daily_log_id: 'Ежедневный учёт',
      destination_department_id: 'Отдел-получатель',
      exchange_rate_to_base: 'Курс к базовой валюте',
      factory_flock_id: 'Партия фабрики',
      flow_type: 'Тип операции',
      parent_id: 'Родительская категория',
      posting_status: 'Статус проводки',
      purpose: 'Назначение',
      ...
      started_on: 'Дата запуска',      total_shelled: 'Всего очищено',
      ...
      target_type: 'Что сохнет',
      period_days: 'Период, дней',
      percent_per_period: 'Процент за период',
      max_total_percent: 'Максимум всего, %',
      stop_after_days: 'Остановить через, дней',
      starts_after_days: 'Грейс-период, дней',
      accumulated_loss: 'Накопленная потеря',
      initial_quantity: 'Начальный вес',
      last_applied_on: 'Последнее списание',
      is_frozen: 'Заморожено',
      lot_type: 'Тип партии',
      lot_id: 'Партия',
      profile_id: 'Профиль усушки',
    },
    crud: {
  ...
  uz: {
    ...
    fields: {
      ...
      acknowledged_at: 'Qabul qilingan sana',
      acknowledged_by: 'Qabul qilgan',
      amount_in_base: 'Bazaviy valyutadagi summa',
      counterparty_id: 'Kontragent',
      counterparty_type: 'Kontragent turi',
      daily_log_id: 'Kunlik hisobot',
      destination_department_id: "Qabul qiluvchi bo'lim",
      exchange_rate_to_base: 'Bazaviy valyutaga kurs',
      factory_flock_id: 'Zavod partiyasi',
      flow_type: 'Operatsiya turi',
      parent_id: 'Ota toifa',
      posting_status: 'Provodka holati',
      purpose: 'Maqsad',
      ...
      started_on: 'Boshlangan sana',      total_shelled: 'Jami tozalangan',
      ...
      target_type: 'Nima quriydi',
      period_days: 'Davr, kun',
      percent_per_period: 'Davr uchun foiz',
      max_total_percent: 'Umumiy maksimal, %',
      stop_after_days: 'Keyin to‘xtatish, kun',
      starts_after_days: 'Grace davri, kun',
      accumulated_loss: 'To‘plangan yo‘qotish',
      initial_quantity: 'Boshlang‘ich miqdor',
      last_applied_on: 'Oxirgi qo‘llash',
      is_frozen: 'Muzlatilgan',
      lot_type: 'Partiya turi',
      lot_id: 'Partiya',
      profile_id: 'Qurish profili',
    },
    crud: {
  ...
  en: {
    ...
    fields: {
      ...
      destination_department_id: 'Destination department',
      exchange_rate_to_base: 'Exchange rate to base',
      factory_flock_id: 'Factory flock',
      flow_type: 'Flow type',
      ...
      started_on: 'Started on',      total_shelled: 'Total shelled',
      unit_cost: 'Unit cost',
      version: 'Version',
      ...
      percent_per_period: 'Percent per period',
      max_total_percent: 'Max total, %',
      stop_after_days: 'Stop after, days',
      starts_after_days: 'Grace period, days',
...
const supplementalTranslationOverrides: Partial<Record<Language, Record<string, unknown>>> = {
  ru: {
    ...
    debtPayments: {
      ...
      errors: {
        ...
        paidOnRequired: 'Укажите дату оплаты.',
      },
      fields: {
        amount: 'Сумма',
        cashAccount: 'Касса',
        cashAccountNone: 'Без кассы',
        method: 'Способ оплаты',
        note: 'Примечание',
        paidOn: 'Дата оплаты',
        referenceNo: 'Номер документа',
      },
      form: {
        fullyPaid: 'Долг полностью погашен.',
        submit: 'Добавить оплату',
        title: 'Добавить оплату',
      },
      headerIncoming: 'Оплаты по долгу клиента',
      headerOutgoing: 'Оплаты поставщику',
      history: {
    ...
    factory: {
      flockKpi: {
        alive: 'В наличии',
        avgWeight: 'Ср. вес (кг)',
        costAlive: 'Себест. на живую птицу',
        costShipped: 'Себест. на отгруж.',
        fcr: 'FCR (корм/прирост)',
        feed: 'Корм',
        ...
        shipped: 'Отгружено',
        title: 'KPI стада',
        totalCost: 'Итого затрат',
      },
    },
    finance: {
      aging: {
        asOf: 'на дату',
        payablesTitle: 'Старение кредиторки',
        receivablesTitle: 'Старение дебиторки',
        total: 'Итого',
      },
    },
    medicine: {
      consume: {
        allocationsTitle: 'Распределение по партиям',
        button: 'Списать (FEFO)',
        clientLabel: 'Клиент (опц.)',
        consumedTotal: 'Списано всего',
        dateLabel: 'Дата',
        errDate: 'Укажите дату',
        errMedicine: 'Выберите препарат',
        errQuantity: 'Введите положительное количество',
        expires: 'до',
        flockLabel: 'Стадо (опц.)',
        medicineLabel: 'Препарат',
        purposeLabel: 'Назначение / комментарий',
        quantityLabel: 'Количество',
        requested: 'Запрошено',
        submit: 'Списать',
        success: 'Списано',
        title: 'Списать лекарство (FEFO)',
      },
    },
    nav: {
      login: 'Войти',
    ...
    dashboard: {
      ...
      dateRangeDescription: 'Выберите период, за который строятся графики и показатели дашборда.',
      revenueCalculatorDescription:
        'Оценка выручки по текущим ценам и отгрузкам за выбранный период.',
    },
    settings: {
    ...
    crud: {
      ...
      acknowledge: 'Принять',
      acknowledgeConfirm: 'Принять',
      acknowledgeNoteLabel: 'Комментарий (опционально)',
      acknowledgeTitle: 'Принять партию',
      acknowledgedTitle: 'Партия принята',
      advanceBalanceTitle: 'Баланс подотчёта',
      advanceIssued: 'Выдано под отчёт',
      advanceOutstanding: 'Остаток за сотрудником',
      advanceReconciled: 'Отчитались',
      advanceReturned: 'Возвращено в кассу',
      bulkClientNotification: 'Массовое уведомление',
      clientNotification: 'Уведомить',
      clientNotificationBulkResult: 'Итог рассылки',
      clientNotificationChannel: 'Канал',
      clientNotificationMessage: 'Сообщение',
      clientNotificationNoClients: 'Нет клиентов для массовой рассылки.',
      clientNotificationNoTarget: 'Клиент не выбран.',
      clientNotificationSend: 'Отправить',
      clientNotificationSendFailed: 'Не удалось отправить уведомление.',
      clientNotificationSent: 'Уведомление отправлено в Telegram.',
      clientNotificationTemplate: 'Шаблон',
      debtOpenCount: 'Открытых долгов',
      debtOutstanding: 'Остаток долга',
      postedLock: 'Проведено',
      recentPurchases: 'Последние покупки',
      reversalCreate: 'Ок, понял',
      reversalInfoTitle: 'Сторно проведённой записи',
      reverse: 'Сторно',
      ...
      sections: {
        ...
        slaughterhouse: {
          metrics: {
            ...
            net_meat_share_pct: { label: 'Доля чистого мяса' },
            waste_share_pct: { label: 'Доля отходов' },
  ...
  uz: {
    ...
    debtPayments: {
      confirmDelete: 'Tasdiqlang',
      errors: {
        amountPositive: 'Musbat summa kiriting.',
        paidOnRequired: 'To‘lov sanasini ko‘rsating.',
      },
      fields: {
        amount: 'Summa',
        cashAccount: 'Kassa',
        cashAccountNone: 'Kassasiz',
        method: 'To‘lov usuli',
        note: 'Izoh',
        paidOn: 'To‘lov sanasi',
        referenceNo: 'Hujjat raqami',
      },
      form: {
        fullyPaid: 'Qarz to‘liq to‘langan.',
        submit: 'To‘lovni qo‘shish',
        title: 'To‘lovni qo‘shish',
      },
      headerIncoming: 'Mijoz qarzi bo‘yicha to‘lovlar',
      headerOutgoing: 'Yetkazib beruvchiga to‘lovlar',
      history: {
    ...
    factory: {
      flockKpi: {
        alive: 'Mavjud',
        avgWeight: 'O‘rt. vazn (kg)',
        costAlive: 'Tirik parranda tannarxi',
        costShipped: 'Jo‘natilgan tannarx',
        fcr: 'FCR (em/o‘sish)',
        feed: 'Em',
        lastLog: 'So‘nggi yozuv',
        medicine: 'Dorilar',
        mortality: 'O‘lim darajasi',
        shipped: 'Jo‘natilgan',
        title: 'Poda KPI',
    ...
    finance: {
      aging: {
        asOf: 'sanaga',
        payablesTitle: 'Kreditor qarzlar eskirishi',
        receivablesTitle: 'Debitor qarzlar eskirishi',
        total: 'Jami',
      },
    },
    medicine: {
      consume: {
        allocationsTitle: 'Partiyalar bo‘yicha taqsimot',
        button: 'Chiqim (FEFO)',
        clientLabel: 'Mijoz (ixt.)',
        consumedTotal: 'Jami chiqim',
        dateLabel: 'Sana',
        errDate: 'Sanani ko‘rsating',
        errMedicine: 'Dori tanlang',
        errQuantity: 'Musbat miqdor kiriting',
        expires: 'gacha',
        flockLabel: 'Poda (ixt.)',
        medicineLabel: 'Dori',
        purposeLabel: 'Maqsad / izoh',
        quantityLabel: 'Miqdor',
        requested: 'So‘ralgan',
        submit: 'Chiqim qilish',
        success: 'Chiqim qilindi',
        title: 'Dorini chiqim qilish (FEFO)',
      },
    },
    nav: {
      login: 'Kirish',
    ...
    dashboard: {
      ...
      dateRangeDescription: 'Dashboard grafiklari va ko‘rsatkichlari tuziladigan davrni tanlang.',
      revenueCalculatorDescription:
        'Tanlangan davr uchun joriy narxlar va jo‘natmalar bo‘yicha tushum baholash.',
    },
    settings: {
    ...
    crud: {
      ...
      acknowledgeConfirm: 'Qabul qilish',
      acknowledgeNoteLabel: 'Izoh (ixtiyoriy)',
      acknowledgeTitle: 'Partiyani qabul qilish',
      acknowledgedTitle: 'Partiya qabul qilindi',
      advanceBalanceTitle: 'Avans balansi',
      advanceIssued: 'Avans berildi',
      advanceOutstanding: 'Xodimdagi qoldiq',
      advanceReconciled: 'Hisob berildi',
      advanceReturned: 'Kassaga qaytarildi',
      bulkClientNotification: 'Ommaviy xabarnoma',
      clientNotification: 'Xabar yuborish',
      clientNotificationBulkResult: 'Yuborish natijasi',
      clientNotificationChannel: 'Kanal',
      clientNotificationMessage: 'Xabar',
      clientNotificationNoClients: 'Ommaviy yuborish uchun mijozlar yo‘q.',
      clientNotificationNoTarget: 'Mijoz tanlanmagan.',
      clientNotificationSend: 'Yuborish',
      clientNotificationSendFailed: 'Xabarnomani yuborib bo‘lmadi.',
      clientNotificationSent: 'Xabarnoma Telegramga yuborildi.',
      clientNotificationTemplate: 'Shablon',
      debtOpenCount: 'Ochiq qarzlar',
      debtOutstanding: 'Qarz qoldig‘i',
      postedLock: 'O‘tkazilgan',
      recentPurchases: 'So‘nggi xaridlar',
      reversalCreate: 'OK, tushundim',
      reversalInfoTitle: 'O‘tkazilgan yozuvni storno qilish',
      reverse: 'Storno',
      saveError: 'O‘zgarishlarni saqlab bo‘lmadi. Qayta urinib ko‘ring.',
    },
    publicMedicine: {
      ...
      sections: {
        ...
        factory: {
          ...
          alerts: {
            factory_high_mortality: {
              ...
              message: 'Nobudgarchilik foizi ruxsat etilgan me’yordan yuqori.',
            },
            factory_overdue_vaccinations: {
              title: 'Muddati o’tgan emlashlar',
              message: 'Faol partiyalar uchun muddati o’tgan emlashlar mavjud.',
            },
          },
        },
        feed_mill: {
        ...
        slaughterhouse: {
          metrics: {
            ...
            net_meat_share_pct: { label: 'Toza go‘sht ulushi' },
            waste_share_pct: { label: 'Chiqindilar ulushi' },
  ...
  en: {
    ...
    debtPayments: {
      ...
      errors: {
        ...
        paidOnRequired: 'Specify the payment date.',
      },
      fields: {
        amount: 'Amount',
        cashAccount: 'Cash account',
        cashAccountNone: 'Without cash account',
      ...
      form: {
        fullyPaid: 'Debt is fully paid.',
        submit: 'Add payment',
        title: 'Add payment',
      },
      headerIncoming: 'Client debt payments',
      headerOutgoing: 'Payments to supplier',
      history: {
    ...
    factory: {
      flockKpi: {
        ...
        costAlive: 'Cost per live bird',
        costShipped: 'Cost per shipped',
        fcr: 'FCR (feed/gain)',
        feed: 'Feed',
        lastLog: 'Last log',
        medicine: 'Medicine',
    ...
    medicine: {
      consume: {
        allocationsTitle: 'Batch allocations',
        button: 'Write off (FEFO)',
        clientLabel: 'Client (opt.)',
        consumedTotal: 'Total written off',
        dateLabel: 'Date',
        errDate: 'Specify the date',
        errMedicine: 'Select a medicine',
        errQuantity: 'Enter a positive quantity',
        expires: 'until',
        flockLabel: 'Flock (opt.)',
    ...
    route: {
      dashboardForbiddenDescription:
        'This page requires expanded permissions to view the financial and operational metrics.',
      moduleForbiddenDescription:
        'Your account does not have permission to read records or analytics for this section.',
      roleManagementForbiddenDescription:
        'Your account does not have permission to read roles and assignments for this page.',
      auditForbiddenDescription:
        'Your account does not have permission to view the audit log for this page.',
    },
    tour: {
      steps: {
        inventoryQuickActions: {
    ...
    crud: {
      ...
      acknowledgeConfirm: 'Confirm',
      acknowledgeNoteLabel: 'Note (optional)',
      acknowledgeTitle: 'Acknowledge batch',
      acknowledgedTitle: 'Batch acknowledged',
      advanceBalanceTitle: 'Advance balance',
      advanceIssued: 'Issued as advance',
      advanceOutstanding: 'Outstanding with employee',
      advanceReconciled: 'Reconciled',
      advanceReturned: 'Returned to cash',
      bulkClientNotification: 'Bulk notification',
      clientNotification: 'Notify',
      clientNotificationBulkResult: 'Bulk send result',
      clientNotificationChannel: 'Channel',
      clientNotificationMessage: 'Message',
      clientNotificationNoClients: 'No clients available for bulk notification.',
      clientNotificationNoTarget: 'No client selected.',
      clientNotificationSend: 'Send',
      clientNotificationSendFailed: 'Failed to send the notification.',
      clientNotificationSent: 'Notification sent via Telegram.',
      clientNotificationTemplate: 'Template',
      debtOpenCount: 'Open debts',
      debtOutstanding: 'Outstanding balance',
      postedLock: 'Posted',
      recentPurchases: 'Recent purchases',
      reversalCreate: 'OK, got it',
      reversalInfoTitle: 'Reverse a posted record',
      reverse: 'Reverse',
      saveError: 'Could not save the changes. Please try again.',
    },
    publicMedicine: {
      ...
      sections: {
        ...
        slaughterhouse: {
          metrics: {
            ...
            net_meat_share_pct: { label: 'Net meat share' },
            waste_share_pct: { label: 'Waste share' },
